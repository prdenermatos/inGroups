...
class ElasticsearchRepository:
    ...
    def find_all(self, index:str, filter:dict) -> list:
        result = []
        result_db = self._elasticsearch.search(index=index, body=filter)
    ...
    def find_one(self, index:str, body:dict):
        return self._elasticsearch.search(index=index, body=body)
